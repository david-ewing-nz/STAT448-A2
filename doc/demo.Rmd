...
```{r}
# Load data
RData_file = "Residen.RData"
RData_path = file.path(data_folder,RData_file)
load(RData_path)
Data <- Residen
...
parkinsons_file = "parkinsons.csv"
parkinsons_path =  file.path(data_folder,parkinsons_file)
parkinsons_data <- read.csv(parkinsons_path, header = TRUE)[-1]
...
```{r}
# Load the data
weather_file <- "Weather_Station_Data_v1.csv"
weather_path <- file.path(data_folder,weather_file)
