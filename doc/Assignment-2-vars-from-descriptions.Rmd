...
<ul style="margin-top: 0;">
  <li><strong>Temporal Alignment:</strong>
    <ul>
      ...
      <li>Correlation between START YEAR and COMPLETION YEAR: (r = 0.988)</li>
    </ul>
  </li>
   The correlation between <strong>START YEAR</strong> and <strong>COMPLETION YEAR</strong>  is extremely high (r = 0.988), indicating that project start and completion years are nearly linearly aligned. This pattern reflects the  stability of construction durations across projects, where scheduling norms and   timelines result in tightly coupled milestone years

The correlation between <strong>START YEAR</strong> and <strong>COMPLETION YEAR</strong> is extremely high, indicating that project start and end years are almost perfectly aligned.  
...
<ul style="margin-top: 0;">
  <li><strong>Start Year Correlations:</strong>
    <ul>
      <li><strong>V9:</strong> V104: Actual Sales Price (r = 0.607)</li>
      <li><strong>V10:</strong> V105: Actual Construction Cost (r = 0.753)</li>
    </ul>
  </li>
</ul>
...
<ul style="margin-top: 0;">
  <li><strong>Completion Year Correlations:</strong>
    <ul>
      <li><strong>V9:</strong> V104: Actual Sales Price (r = 0.613)</li>
      <li><strong>V10:</strong> V105: Actual Construction Cost (r = 0.769)</li>
    </ul>
  </li>
...
<ul style="margin-top: 0;">
  <li><strong>Correlations with Actual Sales Price (V9):</strong>
    <ul>
      <li><strong>V5:</strong> V5: Preliminary estimated construction cost (r = 0.785)</li>
      <li><strong>V8:</strong> V8: Initial unit price (r = 0.976)</li>
    </ul>
  </li>
...
<ul style="margin-top: 0;">
  <li><strong>Correlations with Actual Construction Cost (V10):</strong>
    <ul>
      <li><strong>V4:</strong> V4: Total preliminary estimated construction cost (r = 0.602)</li>
      <li><strong>V5:</strong> V5: Preliminary estimated construction cost (r = 0.963)</li>
    </ul>
  </li>
...
<ul style="margin-top: 0;">
  <li><strong>Predictors of Actual Sales Price (V9):</strong>
    <ul>
      <li><strong>V8:</strong> V8: Initial unit price (r = 0.976), and  </li>
      <li><strong>V5:</strong> V5: Preliminary estimated construction cost (r = 0.785).  </li>
    </ul>
   </li>
...
<ul style="margin-top: 0;">
  <li><strong>Predictors of Actual Construction Cost (V10):</strong>
    <ul>
      <li><strong>V4:</strong> V4: Total preliminary estimated construction cost (r = 0.602)</li>
      <li><strong>V5:</strong> V5: Preliminary estimated construction cost (r = 0.963)</li>
       <li><strong>V8:</strong> V8: Initial unit price (r = 0.790)</li>
    </ul>
  </li>
...
<ul style="margin-top: 0;">
  <li>V10: V105: Building Services Index,</li>
  <li>V11: V11: Wholesale Price Index of Building Materials,</li>
  <li>V13: V13: Cumulative Liquidity,</li>
  <li>V14: V14: Private Sector Investment in New Buildings,</li>
  <li>V15: V15: Land Price Index,</li>
  <li>V19: V19: Average Construction Cost at Completion,</li>
  <li>V20: V20: Average Construction Cost at Beginning,</li>
  <li>V23: V23: Consumer Price Index, </li>
  <li>V24: V24: CPI of Housing, Water, Fuel & Power, and</li>
  <li>V27: V27: Gold Price per Ounce </li>
</ul>
...
<ul style="margin-top: 0;">
  <li><strong>Significant Positive Predictors (p < 0.001):</strong> (Temporal and Financial)
    <ul>
      <li><strong>COMPLETION YEAR:</strong> Completion year (β = 152.1)</li>
